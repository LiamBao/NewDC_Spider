...
public class FindDialog extends javax.swing.JDialog {
	...
	public FindDialog(SwingGui swingGui, String title) {
	...
	public static void main(String[] args) {
		FindDialog f = new FindDialog(null, "Hello");
		f.addNotify();
		f.doShow();
	}
	...
	private void doFind(boolean isPrev) {
		...
		addEditValueIntoCmbList(cmbFrom);
		if (isPrev)
			lblStatusBar.setText(gui.getFindAndReplaceUtil().findPrev((String) cmbFrom.getSelectedItem()));
		else
			lblStatusBar.setText(gui.getFindAndReplaceUtil().findNext((String) cmbFrom.getSelectedItem()));
