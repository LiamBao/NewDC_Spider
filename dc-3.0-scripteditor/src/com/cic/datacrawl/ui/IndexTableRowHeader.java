 ...
 */
public class IndexTableRowHeader extends JTable {
	 ...
	 *            rowHeader的宽度
	 */
	public IndexTableRowHeader(JTable refTable) {
		...
		this.setPreferredScrollableViewportSize(new Dimension(40, 0));
	}

	public void setWidthByNumber(int num) {
		System.out.println(this.getFont().getSize());
//		int columnWidth = (((int)Math.log10(num)) * this.getFont().getSize()) + 5;
