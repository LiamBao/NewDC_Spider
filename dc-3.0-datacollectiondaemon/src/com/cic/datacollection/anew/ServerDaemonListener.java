...
public class ServerDaemonListener extends Thread{
	
	private static final Logger log = Logger.getLogger(ServerDaemonListener.class);
	...
	public ServerDaemonListener(Configuration conf, String address, int port, int numHandlers){
		this.conf = conf;
