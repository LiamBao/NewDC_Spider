...
public class MD5 
{
    ...
    /**
     * 锟斤拷位锟斤拷锟斤拷abyte0为锟斤拷要锟斤拷锟斤拷MD5锟斤拷锟杰碉拷锟街凤拷i为锟街凤拷锟饺ｏ拷
     * @param abyte0
     * @param i
     */
    ...
    /**
     * 锟斤拷锟秸达拷锟?锟斤拷锟矫碉拷锟斤拷128位锟斤拷16锟街节ｏ拷MD5锟斤拷锟斤拷锟斤拷digest锟斤拷锟斤拷锟斤拷
     *
     */
	...
	/**
	 * 转锟斤拷锟斤拷锟斤拷al锟斤拷long锟酵的憋拷锟斤拷锟絙yte锟酵碉拷锟斤拷锟斤拷abyte0锟叫ｏ拷
    ...
    {
    	 String url =
    		 "http://www.google.com.hk/url?q=http://blog.163.com/ant_1974/blog/static/81263300201143111581534/&sa=U&ei=gzvlTbXEIoemvgO8oaWQBw&ved=0CEAQmAEwCTjeAg&usg=AFQjCNHNeZdAgV3CFziwCNB1pLDSnshCyg";

    		     String seid = "10";

    		     String keyword = "七爽无比";

    		     String projectid = "303";

    		     

//    		       sample: 2EF31D7FB47D29BF536595B22BA5BC03

//    		       result: 397535F2E66D2AFB03EBF913A624FA79

    		     

    		     String refindkey = "2EF31D7FB47D29BF536595B22BA5BC03";

    		     String md5_url = MD5.toMD5(projectid+keyword+seid+url);

    		     
System.out.println("source: " + projectid+keyword+seid+url);
    		     System.out.println("sample: "+refindkey);

    		     System.out.println("result: "+md5_url);
