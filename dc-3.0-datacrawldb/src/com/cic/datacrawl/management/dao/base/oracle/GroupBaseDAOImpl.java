...
public class GroupBaseDAOImpl extends JdbcDaoSupport implements GroupBaseDAO {
	...
	public Group getGroup(long id) {
		String sql = "select id, group_name, site_count, agent_count from t_group where id="
				+ id;
		EntityProcessor processor = new EntityProcessor();
	...
	public Group[] getGroups(final long[] ids) {
		...
		StringBuffer sql = new StringBuffer(
				"select id, group_name, site_count, agent_count from t_group where id in (");
	...
	public long addGroup(final Group group) {
		...
		String sqlSeq = "select S_T_GROUP.nextval from dual";
		final long id = getJdbcTemplate().queryForLong(sqlSeq);

		String sql = "insert into t_group (id,group_name, site_count, agent_count) "
				+ "values(?,?,?,?)";
	...
	public Group queryByName(final java.lang.String name) {
		...
		StringBuffer sql = new StringBuffer(
				"select id, group_name, site_count, agent_count from t_group where group_name=? ");
		EntityProcessor processor = new EntityProcessor();
